  ...
  return (
    ...
    >
      <div>
        ...
        <div className="flex flex-col items-center justify-center h-full text-white mt-25">
          ...
          <p
            className="text-gray-400 italic text-sm md:text-lg mt-14 mb-25 max-w-lg px-6 md:max-w-5xl mx-auto"
